          ...
          <View style={{ flex: 1 }}>
            ...
            >
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (1)</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (2)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (3)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (1)</Text>
            ...
            >
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (4)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (5)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (6)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <MaterialIcons name="school" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>school (4)</Text>

          ...
          <View style={{ flex: 1 }}>
            ...
            >
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (1)</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (2)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (3)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (1)</Text>
            ...
            >
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (4)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (5)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (6)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.iconTouch}>
                <AntDesign name="bank" size={35} color={"#2196f3"} />
                <Text style={styles.txt}>bank (4)</Text>
